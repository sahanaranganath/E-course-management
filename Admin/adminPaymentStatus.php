...
?>  
   <div class="" style="text-align: center; margin-top: 50px">
     <h2 class="text-center my-4" style=" background-color: #E6E6FA; font-weight: bold; font-size: 30px; margin-top: 20px">Payment Status </h2>
     ...
     <div class="form-group row" style="text-align: center; margin-top: 50px">
        ...
        <div style="text-align: center; margin-left: 100px; margin-top: 50px">
          <input class="btn btn-primary mx-4" value="View" type="submit"	onclick="" >
        </div>
      </div>
     </form>
    </div>
    <div class=""style="text-align: center; margin-top: 350px">
    <?php
        ...
        while($row = $result->fetch_assoc()){
          if($_POST["ORDER_ID"] == $row["order_id"]){ ?>
            <div class="row justify-content-center">
              <div class="col-auto">
                <h2 class="text-center" style=" background-color: #E6E6FA; font-weight: bold; font-size: 30px; margin-top: 20px">Payment Receipt</h2>
