...
?>
 ...
 <p class="  text-white p-2" style="background-color: #ADD8E6; font-weight: bold; font-size: 30px">Edit My Profile</p>
  <form class="mx-5" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn btn-success" name="updateStuNameBtn">Update</button>
